...
<main>
    ...
    <div class="page">
        ...
        <div class="partner">
            <h1>Co-workers:</h1>
            <a href="https://github.com/JohanArntzen">Johan Album Arntzen</a>, <a href="https://github.com/StormFire0G">Storm Davidsen</a>
        </div>
...
:global(body.dark-mode) .tekst-right {
    color: white;
}
...
:global(body.dark-mode) .tekst-left {
    color: white;
}
